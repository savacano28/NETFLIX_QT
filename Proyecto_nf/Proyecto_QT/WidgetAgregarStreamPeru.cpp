...
void WidgetAgregarStreamPeru::agregarDatos(){
...
int WidgetAgregarStreamPeru::devolverSize(){
    return BDsperu.size();
}

QVector <string> WidgetAgregarStreamPeru::devolverVec(){
    return BDsperu;
}
