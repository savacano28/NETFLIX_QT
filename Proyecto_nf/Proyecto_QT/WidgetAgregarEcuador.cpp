...
using std::string;
 ...
 QVector <string>  BDecuador;
WidgetAgregarEcuador::WidgetAgregarEcuador(QWidget *parent) :
    QDialog(parent)
{
     ...
     QHBoxLayout *layoutRadial = new QHBoxLayout;
        ...
        connect(botonAceptar,SIGNAL(clicked()),this,SLOT(agregarDatos1()));
        connect (botonCancelar, SIGNAL(clicked()), this, SLOT(reject()));
}

void WidgetAgregarEcuador::agregarDatos1(){
...
int WidgetAgregarEcuador::devolverSize1(){
    return BDecuador.size();
}

QVector <string> WidgetAgregarEcuador::devolverVec1(){
    return  BDecuador;
}
