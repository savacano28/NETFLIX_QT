...
QVector <string> BDsvenezuela;
QVector <int> rowsv;

WidgetAgregarStreamVenezuela::WidgetAgregarStreamVenezuela(QWidget *parent) :
    QDialog(parent)
{
...
void WidgetAgregarStreamVenezuela::agregarDatos(){
...
int WidgetAgregarStreamVenezuela::devolverSize(){
    return BDsvenezuela.size();
}

QVector <string> WidgetAgregarStreamVenezuela::devolverVec(){
    return BDsvenezuela;
}

void WidgetAgregarStreamVenezuela::ponerTabla(int row, int col){
    ...
    if(col==0){
        ...
        if(var==0){
            rowsv.append(row);
            BDsvenezuela.replace(pos,"1");
        }else{
            rowsv.remove(pos_r);
            BDsvenezuela.replace(pos,"0"); }
        }}
