...
WidgetVisualizarEcuador::WidgetVisualizarEcuador(int n, QWidget *parent) :
    QDialog(parent)
{
...
void WidgetVisualizarEcuador::armar(){

    QVector <string> x =widgetAgregarEcuador->devolverVec1();
    int n=widgetAgregarEcuador->devolverSize1();
