#ifndef WIDGETAGREGARSTREAMVENEZUELA_H
#define WIDGETAGREGARSTREAMVENEZUELA_H
...
class WidgetAgregarStreamVenezuela : public QDialog
{
    Q_OBJECT
public:
    explicit WidgetAgregarStreamVenezuela(QWidget *parent = 0);
    int devolverSize();
...
#endif // WIDGETAGREGARSTREAMVENEZUELA_H
